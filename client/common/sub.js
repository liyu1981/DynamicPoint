sub = function() {
  ...
  switch(dpMode) {
    case 'profile':
      return [ Meteor.subscribe('DPConf'), Meteor.subscribe('Decks') ];

    case 'author':
      return [ Meteor.subscribe('DPConf'), Meteor.subscribe('Decks', dpUrlParams.query.id) ];
    ...
    case 'superview':
    case 'export':
      return [ Meteor.subscribe('DPConf') ];
